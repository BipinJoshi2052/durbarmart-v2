...
<!-- Fonts -->
<link href="https://fonts.googleapis.com/css2?family=Baloo+Bhaijaan+2:wght@400;500;600;700;800&family=DM+Serif+Display:ital@0;1&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,500;1,600;1,700&family=Vidaloka&display=swap" rel="stylesheet" media="none" onload="if(media!='all')media='all'">

<link rel="stylesheet" href="{{asset('template/css/bootstrap.minn.css')}}" type="text/css" media="all">

<link rel="stylesheet" href="{{asset('template/css/slick.css')}}" media="none" onload="if(media!='all')media='all'"/>
<link rel="stylesheet" href="{{asset('template/css/slick-theme.css')}}" media="none" onload="if(media!='all')media='all'"/>
<link rel="stylesheet" href="{{asset('template/css/custom.css')}}" media="none" onload="if(media!='all')media='all'"/>
<link rel="stylesheet" href="{{asset('template/css/responsive.css')}}" media="none" onload="if(media!='all')media='all'"/>
            ...
            <div class="top-social-icon">
              <ul class="mb-0">
                <li>
                  ...
                  <a href="{{ route('wishlists.index') }}" class="wishlist_mobile">
                    <i class="fa fa-heart-o" aria-hidden="true"></i>
                    @if(Auth::check())
                    <span class="font-weight-normal">{{ count(Auth::user()->wishlists)}}</span>
                            {{-- <span class="nav-box-number">{{ count(Auth::user()->wishlists)}}</span> --}}
                        @else
                        <span class="font-weight-normal">Wishlist</span>
                            {{-- <span class="nav-box-number">0</span> --}}
                        @endif
                    {{-- <i class="fa fa-heart-o" aria-hidden="true"></i>
                    <span class="font-weight-normal">Wishlist</span> --}}
                  ...
                  <div class="dropdown user_login_mobile">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="login.html" class="font-weight-normal"
                          ><span class="pr-2"
                      ...
                      <li>
                        <a href="register.html" class="font-weight-normal"
                          ><span class="pr-2"
                            ><i
                              class="fa fa-sign-in"
                              aria-hidden="true"
...
<script type="text/javascript" src="{{asset('template/js/jquery-3.3.1.minn.js')}}"></script>
    ...
    <script src="{{asset('template/js/font-awesom.js')}}"></script>
